...
const tabClasses = computed(() => {
  const theme = {
    tab: {
      base: 'inline-flex items-center justify-center px-4 py-2 font-medium transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed',
      variants: {
        default: {
